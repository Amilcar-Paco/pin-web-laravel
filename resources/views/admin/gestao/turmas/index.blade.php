                    ...
                    @foreach($todas_turmas as $key => $turma)
                        <tr data-entry-id="">
                            ...
                            <td>
                                    ...
                                    <a class="btn btn-xs btn-info" title="Editar turma">
                                    <i class="fas fa-pen"></i>
                                    </a>
                                
                                    <a class="btn btn-xs btn-danger" href="{{ route('admin.turmas.index') }}" onclick="removerCurso(confirm('{{ trans('global.areYouSure') }}'), '{{ $turma['chave']}}');" style="display: inline-block;" title="Remover turma">
