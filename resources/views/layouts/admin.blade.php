...
<head>
  ...
  <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
    ...
    <link href="{{ asset('js/custom/time/tpicker.css') }}" rel="stylesheet" />
...
<body class="sidebar-mini sidebar-open" style="height: auto;">
    <div class="wrapper">
        ...
        <footer class="main-footer">
            ...
            <strong> &copy;</strong> {{ trans('global.allRightsReserved') }} Desenvolvido por {{ trans('global.paco') }} & {{ trans('global.lifanica') }} 
        </footer>
    ...
    <script src="{{ asset('js/custom/connect.js') }}"></script>
    <script src="{{ asset('js/custom/uploudCourse.js') }}"></script>
    <script src="{{ asset('js/custom/updateCourse.js') }}"></script>
    <script src="{{ asset('js/custom/remove.js') }}"></script>
    <script src="{{ asset('js/custom/updatePay.js') }}"></script>
    <script src="{{ asset('js/custom/time/tpicker.js') }}"></script>
    <script src="{{ asset('js/custom/turma.js') }}"></script>
    <script src="{{ asset('js/custom/total.js') }}"></script>
...
/*
  ...
  var firebaseConfig = {
    apiKey: "AIzaSyDQMID_M74gcRZkL8hzXjzub4n_pmP3Eug",
    authDomain: "pinapp-96d0a.firebaseapp.com",
    databaseURL: "https://pinapp-96d0a.firebaseio.com",
    projectId: "pinapp-96d0a",
    storageBucket: "pinapp-96d0a.appspot.com",
    messagingSenderId: "319843261751",
    appId: "1:319843261751:web:417c4b096c9581c6998eb2",
    measurementId: "G-B31XTXJ6X8"
  };
  // Initialize Firebase
...
*/
  ...
  // Your web app's Firebase configuration
  var firebaseConfig = {
    apiKey: "AIzaSyBGnmVIThOTIgMUtpF79mihOsxqVqdGQnI",
    authDomain: "pinv2-800f4.firebaseapp.com",
    databaseURL: "https://pinv2-800f4.firebaseio.com",
    projectId: "pinv2-800f4",
    storageBucket: "pinv2-800f4.appspot.com",
    messagingSenderId: "722493663358",
    appId: "1:722493663358:web:00b34320f92c32e8fe902f",
    measurementId: "G-D6XMZKJTPP"
  };
  // Initialize Firebase
  firebase.initializeApp(firebaseConfig);

  const db = firebase.firestore();
  db.settings({ timestampInSnapshtos: true}); 
